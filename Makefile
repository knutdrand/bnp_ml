...
test-all: ## run pytest, doctests, examples
	pytest --cov=bnp_ml --cov-report html
	pytest --cov=bnp_ml --cov-report html --cov-append scripts/*_example.py
	pytest --cov-report html --cov=bnp_ml --cov-append --doctest-modules bnp_ml/
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs_source/bnp_ml.rst
	rm -f docs_source/modules.rst
	sphinx-apidoc -o docs_source/ bnp_ml
